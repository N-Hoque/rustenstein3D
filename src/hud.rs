use rsfml::graphics::{
    Color, PrimitiveType, RectangleShape, RenderTarget, RenderWindow, Shape, Transformable, Vertex,
    VertexArray,
};
...
impl<'s> HUD<'s> {
    ...
    fn draw_line(
        ...
        self.hud_vertex_array
            .append(&Vertex::with_pos_color(Vector2f { x: x1, y: y1 }, *color));
        self.hud_vertex_array
            .append(&Vertex::with_pos_color(Vector2f { x: x2, y: y2 }, *color));
    ...
    fn draw_2line(
        ...
        self.hud_vertex_array
            .append(&Vertex::with_pos_color(Vector2f { x: x2, y: y2 }, *color));
        self.hud_vertex_array
            .append(&Vertex::with_pos_color(Vector2f { x: x3, y: y3 }, *color));
        render_window.draw(&self.hud_vertex_array);
    }
